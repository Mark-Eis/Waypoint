...
#'
#' The \code{as_cords()} method for class \code{"coords"} returns the original \code{numeric} vector
#' argument \code{object} modified in place, whereas the method for class 'waypoints' returns a 
#' new \code{numeric} vector.
#'
